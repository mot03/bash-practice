...
--
-- Name: bikes bikes_bike_id_key; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.bikes
    ADD CONSTRAINT bikes_bike_id_key UNIQUE (bike_id);
...
--
-- Name: rentals rentals_rental_id_key; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.rentals
    ADD CONSTRAINT rentals_rental_id_key UNIQUE (rental_id);
